...
// Dados EXATOS do modelo Shadcn Admin Dashboard
const leadsData = [
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6 space-y-6">
        ...
        {/* Sales Pipeline and Sales by Region EXATOS do modelo */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Sales Pipeline */}
          <Card>
            <CardHeader>
        ...
        {/* Action Items and Recent Leads EXATOS do modelo */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Recent Leads Table EXATA do modelo */}
